...
Which check 1) path of file relative to Git directory 2) Org mode for buffer.hich checks 1) the path of the file relative to the Git directory 2) Org mode for the buffer.
* Features
